    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {activePage === "Workloads" && <WorkloadsPage />}
          {activePage === "Orchestration" && <OrchestrationPage />}
        </div>
      </main>
    </div>
  );
